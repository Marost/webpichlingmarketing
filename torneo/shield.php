								...
								<section>
									...
									<div class="post">
										<header>
											...
											<span class="byline">Cambiar Foto de Escudo</span>
										</header>
										...
										<div class="g-form-group-rows">
                                            ...
                                            <div class="g-form-row">
												<div class="g-form-row-label">
                                                	<label class="g-form-row-label-h" for="escudo">Subir Nuevo Escudo: </label>
												</div>
...
if(is_uploaded_file($_FILES['uploadedfile']['tmp_name'])) { // verifica haya sido cargado el archivo
	...
	exit();
														...
														$escudo = $nambre;
														$sql = "UPDATE pmkt_equipo SET escudo='$escudo' WHERE id='$id'"; 
														mysql_query($sql);
														$_SESSION["id"] = $id;
