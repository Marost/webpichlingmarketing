                ...
                <div id="contenido">
                  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                    <tr>
                      ...
                      <form id="form1" name="form1" method="get" action="../../../paginas/usuarios/administracion/listar.php">
                    ...
                    <tbody>
                        ...
                        <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="10%" align="center">
                                    ...
                                    <a href="../../../paginas/usuarios/administracion/form-modificar.php?usuario=<?php echo $fila_usuarios["usuario"]?>">
