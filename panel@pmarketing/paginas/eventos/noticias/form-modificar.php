...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_evento WHERE id=". $_REQUEST["id"].";", $conexion);
$fila_query=mysql_fetch_array($rst_query);

//TAGS
$tags=explode(",", $fila_query["tags"]);	//SEPARACION DE ARRAY CON COMAS
$rst_tags=mysql_query("SELECT * FROM ".$tabla_suf."_evento_tags WHERE id>0 ORDER BY nombre ASC;", $conexion);
...
jq(function() {
	jq("#flash_uploader").pluploadQueue({
		...
		filters : [ {title : ".jpg | .png | .gif", extensions : "jpg,png,gif,jpeg"}],
		resize : {width : 640, height : 500, quality : 80},
