...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_servicios WHERE id>0 ORDER BY titulo DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_servicios WHERE id>0 ORDER BY titulo DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_servicios WHERE titulo LIKE '%$buscar%' ORDER BY titulo DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_servicios WHERE titulo LIKE '%$buscar%' ORDER BY titulo DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
