...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_servicios WHERE id=". $_REQUEST["id"].";", $conexion);
$fila_query=mysql_fetch_array($rst_query);

//TAGS
$tags=explode(",", $fila_query["tags"]);	//SEPARACION DE ARRAY CON COMAS
$rst_tags=mysql_query("SELECT * FROM ".$tabla_suf."_servicios_tags WHERE id>0 ORDER BY nombre ASC;", $conexion);
