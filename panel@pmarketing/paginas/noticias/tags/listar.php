    ...
    <div id="contenido_total">
        ...
        <div id="contenido">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p class="seccion"><strong><a href="../../../paginas/noticias/tags/form-agregar.php">AGREGAR TAG</a></strong></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <?php //if($fila_prv_user["noticias_modificar"]==1){ ?>
                                <a href="../../../paginas/noticias/tags/form-modificar.php?id=<?php echo $fila["id"] ?>">
