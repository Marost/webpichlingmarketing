...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_empresa_enlaces WHERE id>0 ORDER BY titulo ASC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_empresa_enlaces WHERE id>0 ORDER BY titulo ASC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_empresa_enlaces WHERE titulo LIKE '%$buscar%' ORDER BY titulo ASC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_empresa_enlaces WHERE titulo LIKE '%$buscar%' ORDER BY titulo ASC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="85%">
                              ...
                              <p>Categoria: <strong>
								<?php 
									...
									$sql=mysql_query("SELECT * FROM ".$tabla_suf."_empresa_enlaces_categoria WHERE id=$idcategoria;", $conexion);									
                            ...
                            <td width="15%" align="center">
                                ...
                                <img src="../../../images/eliminar_16.png" width="16" height="16" title="Eliminar registro" /></a>
                               	...
                               	<img src="../../../images/editar_16.png" width="16" height="16" title="Modiciar registro" /></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
