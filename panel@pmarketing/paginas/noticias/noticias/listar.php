...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                ...
                                <img src="../../../images/mult_32.png" width="16" height="16" title="Galeria de fotos" /></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
