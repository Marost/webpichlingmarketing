...
//EDITAR
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_clientes WHERE id=$id_url;", $conexion);
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Relaciones Comerciales</span>
    </div>
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9">
                            <div class="floatL">
                                <a href="../../../imagenes/clientes/<?php echo $nota_imagen; ?>" class="lightbox">
                                    <img src="../../../imagenes/clientes/<?php echo $nota_imagen; ?>" width="100" >
                                </a>
                            </div>
                            <div class="widget floarL width60 margin1020">    
                                <div id="uploader_clientes">Tu navegador no soporta HTML5.</div>
