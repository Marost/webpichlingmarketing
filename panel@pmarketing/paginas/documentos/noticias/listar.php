...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_documento WHERE categoria=$tipo ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_documento WHERE categoria=$tipo ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_documento WHERE categoria=$tipo AND titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_documento WHERE categoria=$tipo AND titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
...
//TIPO DE DOCUMENTO
if($tipo==1){ $tipo_nombre="Distrito Electoral"; }
elseif($tipo==2){ $tipo_nombre="Ley de Retorno"; }
?>
...
function eliminarRegistro(registro, nombre, tipo) {
if(confirm("¿Está seguro de borrar este registro?\n"+nombre)) {
	document.location.href="eliminar.php?id="+registro+"&tipo="+tipo;
	}
}
</script>
</head>
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Lista - <?php echo $tipo_nombre; ?></h2>
    <div id="contenido_total">
        ...
        <div id="contenido">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p><a href="form-agregar.php?tipo=<?php echo $tipo; ?>"><strong>AGREGAR</strong></a></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                      <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        <thead>
                          <tr class="titulo-campo">
                            <th width="85%" height="22" align="left"><?php echo $tipo_nombre; ?></th>
                            ...
                            <td width="85%">
                              ...
                              por: <strong><?php echo $fila["dato_usuario"] ?></strong></p>
								...
								<?php 
									...
									$sql=mysql_query("SELECT * FROM ".$tabla_suf."_documento_categoria WHERE id=$idcategoria;", $conexion);									
									$fila_sql=mysql_fetch_array($sql);
									echo $fila_sql["categoria"];
								?>
						    </strong></p></td>
                            <td width="15%" align="center">
                                <a onclick="eliminarRegistro(<?php echo $fila["id"] ?>, '<?php echo $fila["titulo"] ?>', <?php echo $tipo; ?>);" href="javascript:;">
                                    <img src="../../../images/eliminar_16.png" width="16" height="16" border="0" title="Eliminar registro" /></a>
                                    
                           		<a href="form-modificar.php?tipo=<?php echo $tipo; ?>&id=<?php echo $fila["id"] ?>">
                               	<img src="../../../images/editar_16.png" width="16" height="16" border="0" title="Modiciar registro" /></a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
