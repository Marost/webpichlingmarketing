...
//CATEGORIA
$rst_categoria=mysql_query("SELECT * FROM ".$tabla_suf."_documento_categoria WHERE id>0 ORDER BY categoria ASC;", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Agregar - <?php echo $tipo_nombre; ?></h2>
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form action="guardar.php?tipo=<?php echo $tipo; ?>" method="post" enctype="multipart/form-data" id="form1" >
