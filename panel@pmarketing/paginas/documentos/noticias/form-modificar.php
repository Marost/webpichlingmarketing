...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_documento WHERE id=". $_REQUEST["id"].";", $conexion);
...
jq(function() {
	jq("#flash_uploader").pluploadQueue({
		...
		filters : [ {title : ".doc | .docx | .xls | .xlsx | .ppt | .pptx | .jpg | .jpeg | .gif | .png | .pdf", extensions : "doc,docx,xls,xlsx,ppt,pptx,jpg,jpeg,gif,png,pdf"}],
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Modificar - <?php echo $tipo_nombre; ?></h2>
    <div id="contenido_total">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
            	<td>
                <form action="actualizar.php?tipo=<?php echo $tipo; ?>&id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            	    ...
            	    <tr>
            	      <td height="30" align="right" ><p><strong>Adjunta enlace:</strong></p></td>
            	      <td height="30" align="left"><input name="enlace" type="text" id="enlace" value="<?php echo $fila_query["enlace"] ?>" size="50" /></td>
          	      </tr>
                  
                  <?php if($fila_query["documento"]!=""){ ?>
            	  <tr>
            	      <td height="30" align="right"><p><strong>Documento:</strong></p></td>
            	      <td height="30" align="left">
                      <a href="<?php echo $web."archivos/".$fila_query["carpeta_documento"]."".$fila_query["documento"]; ?>" target="_blank">
                      <img src="../../../images/download.png" width="171" height="50" /></a></td>
          	      </tr>
                  <?php } ?>
                  
            	    <tr>
            	      <td colspan="2">
                      <strong><p>o adjunta un documento</p></strong>
                      <div>
