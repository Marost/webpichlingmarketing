...
<div id="contenedor" class="limpiar">
    ...
    <div id="contenido_total">
    	<div id="mensaje" >
        	<form id="form1" name="form1" method="get" action="../../paginas/videos/listar.php">
        ...
        <div id="contenido">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p><a href="../../paginas/videos/form-agregar.php"><strong>AGREGAR</strong></a></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                <a onclick="eliminarRegistro(<?php echo $fila["id"] ?>, '<?php echo $fila["titulo"] ?>');" href="javascript:;">
                           		...
                           		<a href="../../paginas/videos/form-modificar.php?id=<?php echo $fila["id"] ?>">
