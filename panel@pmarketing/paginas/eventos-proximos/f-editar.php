...
//EDITAR
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_evento_proximos WHERE id=$id_url;", $conexion);
...
$nota_contenido=$fila_nota["contenido"];
$nota_evento_cliente=$fila_nota["ev_cliente"];
$nota_evento_lugar=$fila_nota["ev_lugar"];
$nota_evento_fecha=$fila_nota["ev_fecha"];
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Próximos Eventos</span>
    </div>
        ...
        <form id="submit-form" class="main" method="POST" action="s-editar.php?id=<?php echo $id_url; ?>">
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        <div class="grid3"><label>Cliente Evento:</label></div>
                        <div class="grid9"><input type="text" name="evento_cliente" value="<?php echo $nota_evento_cliente; ?>" /></div>
                    </div>

                    <div class="formRow">
                        <div class="grid3"><label>Lugar Evento:</label></div>
                        <div class="grid9"><input type="text" name="evento_lugar" value="<?php echo $nota_evento_lugar; ?>" /></div>
                    </div>

                    <div class="formRow">
                        <div class="grid3"><label>Fecha Evento:</label></div>
                        <div class="grid9"><input type="text" name="evento_fecha" value="<?php echo $nota_evento_fecha; ?>" /></div>
                    </div>
