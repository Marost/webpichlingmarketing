					...
					<div class="rm-wrapper">
						...
						<div class="rm-cover">
							...
							<div class="rm-front">
								<div class="rm-content">
									<img src="images/caratula.png" width="100%"  style="margin: 150px 0px 100px 0px;">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dt><img src="images/parte_izquierdo.png" width="100%"></dt>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
                                	<dl>
	                                    <dt><img src="images/parte_central.png" width="100%"></dt>
                                    </dl>
								</div><!-- /rm-content -->
								<div class="rm-overlay"></div>
							</div><!-- /rm-inner -->
