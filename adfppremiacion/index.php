					...
					<div class="rm-wrapper">
						...
						<div class="rm-cover">
							...
							<div class="rm-front">
								<div class="rm-content">
									<img src="images/caratula3.png" width="100%"  style="margin: 150px 0px 100px 0px;">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dt><img src="images/f_izquierdo3.png" width="100%"></dt>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
                                	<dl>
	                                    <dt><img src="images/txt_central3.png" width="100%"></dt>
                                    </dl>
								</div><!-- /rm-content -->
								<div class="rm-overlay"></div>
							</div><!-- /rm-inner -->
						...
						<div class="rm-right">
							...
							<div class="rm-back">
                                ...
                                <div class="rm-info">
                                    ...
                                    <img src="images/isotipo_negro3.png" width="150px">
                                </div>
							</div><!-- /rm-back -->
