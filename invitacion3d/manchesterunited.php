...
<div class="rm-info">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dd><img src="images/rooney.jpg"/></dd>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
									<h4>Invitación</h4>
									<dl>
										<dd><img src="images/invitacion4.jpg"/></dd>
                                        <dt>Completa tus datos y confirma tu participación</dt>
                                        <form action="manchesterunited.php" method="post" id="subscribe-form" style="display:block">
                                            <span>
                                            ...
                                            <span>
                                                ...
                                                <input type="hidden" name="equipo" value="Manchester United">
                                            <span>
                                            <span>
						...
						<div class="rm-right">
							...
							<div class="rm-back">
								...
								<div class="rm-content">
									<dl>
										<dd><img src="images/manchester.jpg"/></dd>
									</dl>
								</div><!-- /rm-content -->
							</div><!-- /rm-back -->
