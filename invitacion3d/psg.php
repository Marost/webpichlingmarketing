...
<div class="rm-info">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dd><img src="images/ibrahimovic.jpg"/></dd>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
									<h4>Invitación</h4>
									<dl>
										<dd><img src="images/invitacion3.jpg"/></dd>
                                        <dt>Completa tus datos y confirma tu participación</dt>
                                        <form action="psg.php" method="post" id="subscribe-form" style="display:block">
                                            <span>
                                            ...
                                            <span>
                                                ...
                                                <input type="hidden" name="equipo" value="PSG">
                                            <span>
                                            <span>
