...
<div class="rm-info">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dd><img src="images/messi.jpg"/></dd>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
									<h4>Invitación</h4>
									<dl>
										<dd><img src="images/invitacion.jpg"/></dd>
                                        <dt>Completa tus datos y confirma tu participación</dt>
                                        <form action="fcbarcelona.php" method="post" id="subscribe-form" style="display:block">
                                            <span>
						...
						<div class="rm-right">
							...
							<div class="rm-back">
								...
								<div class="rm-content">
									<dl>
										<dd><img src="images/barcelona.jpg"/></dd>
									</dl>
								</div><!-- /rm-content -->
							</div><!-- /rm-back -->
