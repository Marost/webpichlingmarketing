					...
					<div class="rm-wrapper">
						...
						<div class="rm-cover">
							...
							<div class="rm-front">
								<div class="rm-content">
									<img src="images/caratula01.png" width="100%"  style="margin: 150px 0px 100px 0px;">
							...
							<div class="rm-back">
								<div class="rm-content">
									<dl>
										<dt><img src="images/parte_izquierda01c.png" width="100%"></dt>
									</dl>
								</div><!-- /rm-content -->
						...
						<div class="rm-middle">
							<div class="rm-inner">
								<div class="rm-content">
                                	<dl>
	                                    <dt><img src="images/parte_central01a.png" width="100%"></dt>
                                    </dl>
								</div><!-- /rm-content -->
								<div class="rm-overlay"></div>
							</div><!-- /rm-inner -->
						...
						<div class="rm-right">
							...
							<div class="rm-back">
                                ...
                                <div class="rm-info">
                                    ...
                                    <img src="images/isotipo_negro01.png" width="150px">
                                </div>
							</div><!-- /rm-back -->
